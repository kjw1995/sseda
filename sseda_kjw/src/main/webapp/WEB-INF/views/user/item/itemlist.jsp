...
<center>
	...
	<c:forEach items="${item }" var="i" >
		<table class="itemlist" border="1">
			<tr><td colspan="2" style="height:150px;"onclick="location.href='/item/detail?no=${i.seqno}'">
			<c:if test="${i.cfcheck == 'O' }"><div style="height:150px;"><img src="/img/멘토.jpg" style="height:100%;width:100%;"></c:if>
			<c:if test="${i.cfcheck == 'I' }"><div style="height:150px;"><img src="/img/멘티.jpg" style="height:100%;width:100%;"></c:if></div></td>
